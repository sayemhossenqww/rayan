...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Employees'); ?></div>
        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary"><?php echo app('translator')->get('Create'); ?></a>
    </div>
    <div class="card w-100">
        <div class="card-body">
            <div class="mb-3">
                <form action="<?php echo e(route('employees.index')); ?>" role="form">
                ...
                <table class="table table-hover table-striped table-hover-x">
                    ...
                    <tbody class="border-top-0">
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="align-middle fw-bold py-3"><?php echo e($employee->name); ?> </td>
                                <td class="align-middle fw-bold"><?php echo e($employee->price); ?> </td>
                                <td class="align-middle fw-bold"><?php echo e($employee->date); ?></td>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <form
                                                        ...
                                                        method="POST" id="form-<?php echo e($employee->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="button"
                                                            class="btn btn-link p-0 m-0 w-100 text-start text-decoration-none text-danger"
                                                            onclick="submitDeleteForm('<?php echo e($employee->id); ?>')">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\Website\habib0827\Trans food Trading\bin\resources\views/employees/index.blade.php ENDPATH**/ ?>