    ...
    <div class="card w-100">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-center mb-3">
                <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Payments'); ?></div>
                <a href="<?php echo e(route('customers.payments.create', $customer)); ?>"
                    class="btn btn-primary me-2"><?php echo app('translator')->get('Create Payment'); ?></a>
                ...
                <div class="modal" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo e(route('customers.payments.filter', $customer)); ?>" method="GET"
                                role="form">
            ...
            <form action="<?php echo e(route('customers.payments.index', $customer)); ?>" role="form">
                <div class="input-group">
                    <input type="search" name="search_query" value="<?php echo e(Request::get('search_query')); ?>"
                        class="form-control" placeholder="<?php echo app('translator')->get('Search...'); ?>" autocomplete="off">
                    <button class="btn btn-outline-primary" type="submit" id="button-addon2"><?php echo app('translator')->get('Search'); ?></button>
                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow-sm"
                                            ...
                                            <li>
                                                <a class="dropdown-item" target="_blank"
                                                    href="<?php echo e(route('customers.payments.print', [$customer, $payment])); ?>">
                                                    <?php echo app('translator')->get('Print'); ?>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('customers.payments.edit', [$customer, $payment])); ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <form
                                                        action="<?php echo e(route('customers.payments.destroy', [$customer, $payment])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/wmktechn/xsmart.wmktech.net/resources/views/customers/payments/index.blade.php ENDPATH**/ ?>