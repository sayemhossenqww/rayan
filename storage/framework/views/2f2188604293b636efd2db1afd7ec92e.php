...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Staffs'); ?></div>
        <a href="<?php echo e(route('staffs.create')); ?>" class="btn btn-primary"><?php echo app('translator')->get('Create'); ?></a>
    </div>
    <div class="card w-100">
        <div class="card-body">
            <div class="mb-3">
                <form action="<?php echo e(route('staffs.index')); ?>" role="form">
                ...
                <table class="table table-hover table-striped table-hover-x">
                    ...
                    <tbody class="border-top-0">
                        <?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="align-middle fw-bold py-3"><?php echo e($staff->name); ?> </td>
                                <td class="align-middle fw-bold"><?php echo e($staff->order); ?> </td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow-sm"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('staffs.attendance', $staff)); ?>">
                                                    <?php echo app('translator')->get('Attendance'); ?>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('staffs.milk.details', $staff)); ?>">
                                                    <?php echo app('translator')->get('Milk Details'); ?>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('staffs.edit', $staff)); ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <form
                                                        action="<?php echo e(route('staffs.destroy', $staff)); ?>"
                                                        method="POST" id="form-<?php echo e($staff->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="button"
                                                            class="btn btn-link p-0 m-0 w-100 text-start text-decoration-none text-danger"
                                                            onclick="submitDeleteForm('<?php echo e($staff->id); ?>')">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Apple\PHP\WMK\CowMilkVillage_16092\CowMilkVillage\bin\resources\views/staffs/index.blade.php ENDPATH**/ ?>