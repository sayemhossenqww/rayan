        ...
        <a href="#"
            ...
            <div>
                <span class="fs-3 text-black">
                    <span class="fw-bold">
                        <?php echo e($debit_sum); ?>

                    </span>
                </span>
                <span class="d-block mt-1 small text-black">
                    <?php echo app('translator')->get('Total Debit'); ?>
                </span>
            </div>
    ...
    <div class="col-md-4">
        <a href="#"
            ...
            <div>
                <span class="fs-3 text-black">
                    <span class="fw-bold">
                        <?php echo e($credit_sum); ?>

                    </span>
                </span>
                <span class="d-block mt-1 small text-black">
                    <?php echo app('translator')->get('Total Credit'); ?>
                </span>
            </div>
            <div class="d-flex align-items-center">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"
...
<?php /**PATH /home3/wmktechn/xsmart.wmktech.net/resources/views/customers/statements/cards.blade.php ENDPATH**/ ?>