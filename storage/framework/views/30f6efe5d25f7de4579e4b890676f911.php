<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom border-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            ...
            <img src="<?php echo e(asset('images/logo.png')); ?>" height="100" alt="logo">
        </a>
...
<?php /**PATH /opt/lampp/htdocs/wmk_work/Vortex (1)/Vortex/bin/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>