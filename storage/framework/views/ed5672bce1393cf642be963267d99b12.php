...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5"><?php echo app('translator')->get('Profile'); ?></div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td><?php echo app('translator')->get('Name'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->name); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Account №'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->number); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Birthday'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->birthday); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Gender'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->gender); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Civil Status'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->civil_status); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Nationality'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->nationality); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5"><?php echo app('translator')->get('Contact Info'); ?></div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td><?php echo app('translator')->get('Mobile Number'); ?></td>
                    <td class="fw-bold">
                ...
                <tr>
                    <td><?php echo app('translator')->get('Telephone Number'); ?></td>
                    <td class="fw-bold">
                ...
                <tr>
                    <td><?php echo app('translator')->get('Fax'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->fax); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Email'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->email); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5"><?php echo app('translator')->get('Address'); ?></div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td><?php echo app('translator')->get('City'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->city); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Street'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->street_address); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Building'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->building); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Floor'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->floor); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Apartment'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->apartment); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('State'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->state); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Country'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->country); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Zip Code'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->zip_code); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5"><?php echo app('translator')->get('Company Info'); ?></div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('Name'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_name); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('Address'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_street_address); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('City'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_city); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('State'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_state); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('Country'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_country); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Company'); ?> <?php echo app('translator')->get('Zip Code'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->company_zip_code); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5"><?php echo app('translator')->get('Other Info'); ?></div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td><?php echo app('translator')->get('Tax ID Number'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->tax_identification_number); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('Notes'); ?></td>
                    <td class="fw-bold"><?php echo e($customer->notes); ?></td>
                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/wmk_work/Vortex (1)/Vortex/bin/resources/views/customers/show.blade.php ENDPATH**/ ?>