...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        ...
        <a href="<?php echo e(route('payments.create')); ?>" class="btn btn-primary px-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                <div class=" flex-grow-1">
                    <form action="<?php echo e(route('payments.index')); ?>" role="form" class="mb-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow-sm"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('payments.edit', $payment)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\Website\habib0827\Trans food Trading\bin\resources\views/payments/index.blade.php ENDPATH**/ ?>