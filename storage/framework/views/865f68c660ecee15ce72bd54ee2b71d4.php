<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom border-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            ...
            <img src="<?php echo e(asset('images/invoicelogo.PNG')); ?>" height="55" alt="logo">
        </a>
...
<?php /**PATH E:\project\lebanon\coco boss\bin\resources\views/layouts/ordernavbar.blade.php ENDPATH**/ ?>