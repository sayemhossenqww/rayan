<form action="<?php echo e(isset($mounehIndustry) ? route('mouneh-industries.update', $mounehIndustry) : route('mouneh-industries.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
    <?php echo csrf_field(); ?>
    <?php if(isset($mounehIndustry)): ?>
        <?php echo method_field('PUT'); ?>
    <?php endif; ?>
    
    
    <?php if(isset($product)): ?>
        <input type="hidden" id="has_existing_product" value="<?php echo e(json_encode($hasExistingProduct)); ?>">
    <?php endif; ?>

    <!-- Hidden field to pass checkbox state to JavaScript -->
    <input type="hidden" id="is_next_phase" value="<?php echo e($isNextPhaseChecked ? 'true' : 'false'); ?>">


    <!-- Type of Mouneh -->
    <div class="mb-3">
        <label for="type_of_mouneh" class="form-label"><?php echo app('translator')->get('Type of Mouneh'); ?></label>
        <input type="text" name="type_of_mouneh" class="form-control <?php $__errorArgs = ['type_of_mouneh'];
...
unset($__errorArgs, $__bag); ?>" id="type_of_mouneh"
            value="<?php echo e(old('type_of_mouneh', isset($mounehIndustry) ? $mounehIndustry->type_of_mouneh : '')); ?>">
        <?php $__errorArgs = ['type_of_mouneh'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- Quantity of Fruit/Vegetable -->
    <div class="mb-3">
        <label for="quantity_of_fruit_vegetable" class="form-label"><?php echo app('translator')->get('Quantity of Fruit/Vegetable'); ?></label>
        <input type="text" name="quantity_of_fruit_vegetable" class="form-control <?php $__errorArgs = ['quantity_of_fruit_vegetable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="quantity_of_fruit_vegetable"
            value="<?php echo e(old('quantity_of_fruit_vegetable', isset($mounehIndustry) ? $mounehIndustry->quantity_of_fruit_vegetable : '')); ?>">
        <?php $__errorArgs = ['quantity_of_fruit_vegetable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        <label for="quantity_of_sugar_salt" class="form-label"><?php echo app('translator')->get('Quantity of Sugar/Salt'); ?></label>
        <input type="text" name="quantity_of_sugar_salt" class="form-control <?php $__errorArgs = ['quantity_of_sugar_salt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="quantity_of_sugar_salt"
            value="<?php echo e(old('quantity_of_sugar_salt', isset($mounehIndustry) ? $mounehIndustry->quantity_of_sugar_salt : '')); ?>">
        <?php $__errorArgs = ['quantity_of_sugar_salt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- Quantity of Acid -->
    <div class="mb-3">
        <label for="quantity_of_acid" class="form-label"><?php echo app('translator')->get('Quantity of Acid'); ?></label>
        <input type="text" name="quantity_of_acid" class="form-control <?php $__errorArgs = ['quantity_of_acid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="quantity_of_acid"
            value="<?php echo e(old('quantity_of_acid', isset($mounehIndustry) ? $mounehIndustry->quantity_of_acid : '')); ?>">
        <?php $__errorArgs = ['quantity_of_acid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- Glass Used -->
    <div class="mb-3">
        <label for="glass_used" class="form-label"><?php echo app('translator')->get('Glass Used'); ?></label>
        <select name="glass_used" class="form-select <?php $__errorArgs = ['glass_used'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="glass_used">
            <option value="1" <?php echo e(old('glass_used', isset($mounehIndustry) ? $mounehIndustry->glass_used : '') == 1 ? 'selected' : ''); ?>>
                <?php echo app('translator')->get('Yes'); ?>
            </option>
            <option value="0" <?php echo e(old('glass_used', isset($mounehIndustry) ? $mounehIndustry->glass_used : '') == 0 ? 'selected' : ''); ?>>
                <?php echo app('translator')->get('No'); ?>
            </option>
        </select>
        <?php $__errorArgs = ['glass_used'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity" class="form-control <?php $__errorArgs = ['final_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="final_quantity"
            value="<?php echo e(old('final_quantity', isset($mounehIndustry) ? $mounehIndustry->final_quantity : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-check mb-3">
        <input type="checkbox"  id="next_phase" class="form-check-input" name="next_phase" <?php echo e($isNextPhaseChecked ? 'checked' : ''); ?>>
...
<?php endif; ?>
            ...
            <div class="mb-3">
                <label for="item_name_display" class="form-label"><?php echo app('translator')->get('Item Name'); ?></label>
                <input type="text" id="item_name_display" class="form-control" value="<?php echo e(old('name', isset($product) ? $product->name : '')); ?>" readonly>
            </div>
            
            <!-- Hidden input to send the value in the request -->
            <input type="hidden" name="name" id="item_name" value="<?php echo e(old('name', isset($product) ? $product->name : '')); ?>">
...
<?php endif; ?>
               <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.date-input','data' => ['label' => 'Expiry Date','name' => 'expiry_date','value' => ''.e(old('expiry_date', isset($product) ? $product->expiry_date : '')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Expiry Date','name' => 'expiry_date','value' => ''.e(old('expiry_date', isset($product) ? $product->expiry_date : '')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?> -->
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.currency-input','data' => ['label' => 'Unit Price','name' => 'unit_price','value' => ''.e(old('unit_price', isset($product) ? $product->unit_price : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('currency-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Unit Price','name' => 'unit_price','value' => ''.e(old('unit_price', isset($product) ? $product->unit_price : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Cost Unit','name' => 'cost_unit','value' => ''.e(old('cost_unit', isset($product) ? $product->cost_unit : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Cost Unit','name' => 'cost_unit','value' => ''.e(old('cost_unit', isset($product) ? $product->cost_unit : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.number-input','data' => ['label' => 'Box Per Count','name' => 'count_per_box','value' => ''.e(old('count_per_box', isset($product) ? $product->count_per_box : 10)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('number-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Box Per Count','name' => 'count_per_box','value' => ''.e(old('count_per_box', isset($product) ? $product->count_per_box : 10)).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Box Unit','name' => 'box_unit','value' => ''.e(old('box_unit', isset($product) ? $product->box_unit : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Box Unit','name' => 'box_unit','value' => ''.e(old('box_unit', isset($product) ? $product->box_unit : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Weight','name' => 'weight','value' => ''.e(old('weight', isset($product) ? $product->weight : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Weight','name' => 'weight','value' => ''.e(old('weight', isset($product) ? $product->weight : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Unit Barcode','name' => 'unit_barcode','value' => ''.e(old('unit_barcode', isset($product) ? $product->unit_barcode : '')).'','formText' => 'You can also use a scanner']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Unit Barcode','name' => 'unit_barcode','value' => ''.e(old('unit_barcode', isset($product) ? $product->unit_barcode : '')).'','formText' => 'You can also use a scanner']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Unit SKU','name' => 'unit_sku','value' => ''.e(old('unit_sku', isset($product) ? $product->unit_sku : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Unit SKU','name' => 'unit_sku','value' => ''.e(old('unit_sku', isset($product) ? $product->unit_sku : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Box Barcode','name' => 'box_barcode','value' => ''.e(old('box_barcode', isset($product) ? $product->box_barcode : '')).'','formText' => 'You can also use a scanner']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Box Barcode','name' => 'box_barcode','value' => ''.e(old('box_barcode', isset($product) ? $product->box_barcode : '')).'','formText' => 'You can also use a scanner']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Box SKU','name' => 'box_sku','value' => ''.e(old('box_sku', isset($product) ? $product->box_sku : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Box SKU','name' => 'box_sku','value' => ''.e(old('box_sku', isset($product) ? $product->box_sku : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Super Dealer Barcode','name' => 'superdealer_barcode','value' => ''.e(old('superdealer_barcode', isset($product) ? $product->superdealer_barcode : '')).'','formText' => 'You can also use a scanner']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Super Dealer Barcode','name' => 'superdealer_barcode','value' => ''.e(old('superdealer_barcode', isset($product) ? $product->superdealer_barcode : '')).'','formText' => 'You can also use a scanner']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Super Dealer SKU','name' => 'superdealer_sku','value' => ''.e(old('superdealer_sku', isset($product) ? $product->superdealer_sku : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Super Dealer SKU','name' => 'superdealer_sku','value' => ''.e(old('superdealer_sku', isset($product) ? $product->superdealer_sku : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary btn-block d-flex align-items-center mx-3 mt-3 w-75 h-12"
                            ...
                            <?php echo app('translator')->get('Box Barcode Print'); ?>
                        </button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary btn-block d-flex align-items-center mx-3 mt-3 w-75 h-12"
                            onclick="printBarCode('superdealer_barcode')">
                            <?php echo app('translator')->get('Super Dealer Barcode Print'); ?>
                        </button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary btn-block d-flex align-items-center mx-3 mt-3 w-75 h-12"
...
<?php endif; ?>
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            <?php echo app('translator')->get(isset($mounehIndustry) ? 'Update Mouneh Industry' : 'Save Mouneh Industry'); ?>
        </button>
    </div>
</form>
    ...
    <script>
        ...
        function printBarCode(value) {
            ...
            htmlContent += `
                ...
                <div style="text-align: center; padding-right: 1rem;padding-left: 1rem;margin-bottom: 0.5rem;">
                    <?php echo e(isset($product) ? $product->expiry_date_view : ''); ?>

                </div>
                <div style="text-align: center; padding-right: 1rem;padding-left: 1rem;margin-bottom: 0.5rem;">
                    <?php echo e(isset($product) ? $product->description : ''); ?>
...
<?php /**PATH /Applications/htdocs/wmk/pos/resources/views/mounehindustries/partials/form.blade.php ENDPATH**/ ?>