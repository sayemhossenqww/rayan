<div class="d-flex align-items-center justify-content-center mb-3">
    <div class="mb-0">
        <a href="<?php echo e(route('customers.show', $customer)); ?>" class="text-body text-decoration-none">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="fs-5 fw-bold"><?php echo e($customer->name); ?></div>
                    <div class="small"><?php echo e($customer->number); ?></div>
                </div>
            </div>
    ...
    <div class="dropdown ms-auto">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.show', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.statements.index', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="hero-icon-sm me-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
                    <?php echo app('translator')->get('Account Statement'); ?>
                </a>
            </li>


            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.orders.index', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="hero-icon-sm me-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.payments.index', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="hero-icon-sm me-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.payments.create', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="hero-icon-sm me-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a class="dropdown-item" href="<?php echo e(route('customers.edit', $customer)); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="hero-icon-sm me-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /opt/lampp/htdocs/wmk_work/Vortex (1)/Vortex/bin/resources/views/customers/partials/info.blade.php ENDPATH**/ ?>