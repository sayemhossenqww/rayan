<?php
    ...
    $items = [
        ...
        [
            'name' => __('Categories'),
            'route' => $isCashier ? '#' : route('categories.index'),
        ...
        [
            'name' => __('Items'),
            'route' => $isCashier ? '#' : route('products.index'),
...
<?php /**PATH F:\Real\XSmarl-F1(8.10)\XSmarl-F1\bin\resources\views/layouts/sidebar-items.blade.php ENDPATH**/ ?>