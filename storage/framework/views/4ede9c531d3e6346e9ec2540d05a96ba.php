<form action="<?php echo e(isset($supplier) ? route('suppliers.update', $supplier) : route('suppliers.store')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>" id="name"
            value="<?php echo e(old('name', isset($supplier) ? $supplier->name : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="address"
            value="<?php echo e(old('address', isset($supplier) ? $supplier->address : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="phone"
            value="<?php echo e(old('phone', isset($supplier) ? $supplier->phone : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email"
            value="<?php echo e(old('email', isset($supplier) ? $supplier->email : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="notes" rows="3"><?php echo e(old('notes', isset($supplier) ? $supplier->notes : null)); ?></textarea>
...
<?php /**PATH /Users/mohammadmahbub/Downloads/rayahen_1.2/bin/resources/views/suppliers/partials/form.blade.php ENDPATH**/ ?>