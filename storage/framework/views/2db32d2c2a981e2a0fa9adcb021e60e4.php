<?php $__env->startSection('title', __('Create') . ' ' . __('User')); ?>

<?php $__env->startSection('content'); ?>

    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Create'); ?> <?php echo app('translator')->get('User'); ?></div>
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.back-btn','data' => ['href' => ''.e(route('users.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <div class="card w-100">
        <div class="card-body">
            <form action="<?php echo e(route('users.store')); ?>" method="POST" role="form">
                ...
                <div class="mb-3">
                    <label for="role" class="form-label"><?php echo app('translator')->get('Role'); ?>*</label>
                    <select name="role" id="role" class=" form-select">
                        <option value="admin"><?php echo app('translator')->get('Admin'); ?></option>
                        <option value="cashier" selected><?php echo app('translator')->get('Cashier'); ?></option>
                    </select>
...
unset($__errorArgs, $__bag); ?>"
                            id="username" value="<?php echo e(old('username')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        <div class=" form-text"><?php echo app('translator')->get('Used for login'); ?></div>
                    </div>
                    <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\Website\habib0827\Trans food Trading\bin\resources\views/users/create.blade.php ENDPATH**/ ?>