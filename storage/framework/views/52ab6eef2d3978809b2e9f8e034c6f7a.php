...
<?php $component->withAttributes(['class' => 'clickable-cell']); ?>
                <div class="text-center">
                    ...
                    <a href="<?php echo e(Auth::user()->is_cashier ? '#' : route('salesman.index')); ?>"
                        class="stretched-link <?php if(Auth::user()->is_cashier): ?> cursor-not-allowed <?php endif; ?>"></a>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'clickable-cell']); ?>
                <div class="text-center">
                    ...
                    <h3><?php echo app('translator')->get('Cow Farm'); ?></h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\Website\habib0827\Trans food Trading\bin\resources\views/home/show.blade.php ENDPATH**/ ?>