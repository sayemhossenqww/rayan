...
<?php $__env->startSection('title', __('Create') . ' ' . __('Purchase')); ?>

<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Create'); ?> <?php echo app('translator')->get('Purchase'); ?></div>
...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('purchases.store')); ?>" method="POST" role="form">
        <?php echo csrf_field(); ?>
        <div class="card mb-3">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        class="form-control hidden d-hide d-hidden d-none <?php $__errorArgs = ['supplier_name'];
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <a id="addInstant" href="<?php echo e(route('suppliers.create')); ?>" class="small text-decoration-none">
                            <?php echo app('translator')->get('Add Instant'); ?>
                        </a>
                    </div>
                    <div class="col-md-6 mb-3">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <optgroup label="<?php echo e($category->name); ?>">
                                                    <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option data-barcode="<?php echo e($product->barcode); ?>" value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </optgroup>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <input type="text" name="barcode" class="form-control" style="max-width:300px;" placeholder="<?php echo app('translator')->get('Barcode...'); ?>" />
                                    </div>
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohammadmahbub/Downloads/rayahen_1.2/bin/resources/views/purchases/create.blade.php ENDPATH**/ ?>