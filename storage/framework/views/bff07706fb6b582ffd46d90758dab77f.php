                    ...
                    <tbody class="border-top-0">
                        <?php for($i = 0; $i < $sales->count(); $i++): ?>
                            <tr class="clickable-cell"
                                onclick="window.location='<?php echo e(route('sales.show', [Carbon\Carbon::parse($sales[$i]->date)->format('Y-m-d')])); ?>?ts=<?php echo e($sales[$i]->total - $salesOrder[$i]->sum_discount); ?>';">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Apple\PHP\WMK\CowMilkVillage_16092\CowMilkVillage\bin\resources\views/sales/index.blade.php ENDPATH**/ ?>