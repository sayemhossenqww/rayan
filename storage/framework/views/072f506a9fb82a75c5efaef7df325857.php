...
<?php $component->withAttributes(['class' => 'clickable-cell']); ?>
                <div class="text-center">
                    ...
                    <a href="<?php echo e(Auth::user()->is_cashier ? '#' : route('categories.index')); ?>"
                        class="stretched-link <?php if(Auth::user()->is_cashier): ?> cursor-not-allowed <?php endif; ?>"></a>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'clickable-cell']); ?>
                <div class="text-center">
                    ...
                    <a href="<?php echo e(Auth::user()->is_cashier ? '#' : route('products.index')); ?>"
                        class="stretched-link <?php if(Auth::user()->is_cashier): ?> cursor-not-allowed <?php endif; ?>"></a>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Real\XSmarl-F1(8.10)\XSmarl-F1\bin\resources\views/home/show.blade.php ENDPATH**/ ?>