                    ...
                    <tbody class="border-top-0">
                        <?php for($i = 0; $i < $sales->count(); $i++): ?>
                            <tr class="clickable-cell"
                                onclick="window.location='<?php echo e(route('sales.show', [$sales[$i]->date])); ?>?ts=<?php echo e(isset($salesOrder[$i]) ? $sales[$i]->total - $salesOrder[$i]->sum_discount : $sales[$i]->total - 0); ?>';">
                                ...
                                <td class="align-middle py-3">
                                    <?php echo e(currency_format(isset($salesOrder[$i]) ? $sales[$i]->total - $salesOrder[$i]->sum_discount : $sales[$i]->total - 0)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\Website\habib0827\Trans food Trading\bin\resources\views/sales/index.blade.php ENDPATH**/ ?>