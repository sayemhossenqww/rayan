...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('dynamic.svg')); ?>" >
    ...
    <div class="h-100" id="app">
        <?php if(auth()->guard()->check()): ?>
            ...
            <div class="x-container">
                <?php echo $__env->make('layouts.ordernavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH E:\project\lebanon\coco boss\bin\resources\views/layouts/orderapp.blade.php ENDPATH**/ ?>