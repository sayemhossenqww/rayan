<?php $__env->startSection('title', __('Create') . ' ' . __('Cheese and Labneh')); ?>

<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="h4 mb-0 flex-grow-1"><?php echo app('translator')->get('Create'); ?> <?php echo app('translator')->get('Cheese and Labneh'); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Apple\PHP\WMK\CowMilkVillage_16092\CowMilkVillage\bin\resources\views/cheeses/create.blade.php ENDPATH**/ ?>