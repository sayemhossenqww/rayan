    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="filterModalLabel"><?php echo app('translator')->get('Account Statement Filter'); ?></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo e(route('customers.statements.filter', $customer)); ?>" method="GET" role="form">
...
<?php /**PATH /home3/wmktechn/xsmart.wmktech.net/resources/views/customers/statements/filter-modal.blade.php ENDPATH**/ ?>