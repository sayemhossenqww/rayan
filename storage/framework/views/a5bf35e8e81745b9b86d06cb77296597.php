...
<html lang="en" dir="ltr">
    <head>
        <title>Dairy Industry – Milk Details</title>
        <style>
            @media print {
                body {
                    width: 100%;
    ...
    <body>
        <div style="margin-bottom: 0.2rem;text-align: center !important;">
            <div style="text-align: left;">
                <h2>Dairy Industry – Milk Details</h2>
            </div>
...
<?php /**PATH E:\Apple\PHP\WMK\CowMilkVillage_16092\CowMilkVillage\bin\resources\views/milk_details/print.blade.php ENDPATH**/ ?>