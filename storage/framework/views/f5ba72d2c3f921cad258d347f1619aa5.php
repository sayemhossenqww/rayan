...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-center mb-3">
        ...
        <a href="<?php echo e(route('supplier-payments.create')); ?>" class="btn btn-primary px-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                <div class=" flex-grow-1">
                    <form action="<?php echo e(route('supplier-payments.index')); ?>" role="form" class="mb-3">
                    ...
                    <tbody class="border-top-0">
                        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('suppliers.show', $payment->supplier)); ?>"
                                        class=" text-decoration-none  fw-bold">
                                        <?php echo e($payment->supplier->name); ?>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow-sm"
                                            ...
                                            <li>
                                                <a class="dropdown-item" target="_blank"
                                                    href="<?php echo e(route('suppliers.payments.print', [$payment->supplier, $payment])); ?>">
                                                    <?php echo app('translator')->get('Print'); ?>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('supplier-payments.edit', $payment)); ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <form
                                                        action="<?php echo e(route('suppliers.payments.destroy', [$payment->supplier, $payment])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Lebanon\Michael\habib0827\Trans food Trading\bin\resources\views/supplier_payments/index.blade.php ENDPATH**/ ?>