...
@section('content')
    <div class="row">
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/procurement.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Sales Man')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('salesmen.index') }}"
                        class="stretched-link @if (Auth::user()->is_cashier) cursor-not-allowed @endif"></a>
                </div>
            </x-card>
        </div>
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/procurement.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Roots')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('roots.index') }}"
                        class="stretched-link @if (Auth::user()->is_cashier) cursor-not-allowed @endif"></a>
                </div>
            </x-card>
        </div>
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/procurement.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Lines')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('lines.index') }}"
                        class="stretched-link @if (Auth::user()->is_cashier) cursor-not-allowed @endif"></a>
                </div>
            </x-card>
        </div>
        {{-- <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/cash.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Cow Farm')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('manupack.index') }}"
                        class="stretched-link @if (Auth::user()->is_cashier) cursor-not-allowed @endif"></a>
                </div>
            </x-card>
        </div> --}}
        <!-- <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/cash.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Manufacturing and packaging')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('manupack.index') }}"
                        class="stretched-link @if (Auth::user()->is_cashier) cursor-not-allowed @endif"></a>
                </div>
            </x-card>
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    ...
                    <h3>@lang('Dairy Industry')</h3>
                    <a href="{{ route('industry') }}" class="stretched-link"></a>
                </div>
            </x-card>
        </div>
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    ...
                    <h3>@lang('Staffs')</h3>
                    <a href="{{ route('staffs.index') }}" class="stretched-link"></a>
                </div>
            </x-card>
        </div>
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
