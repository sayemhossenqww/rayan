...
class OrderDetail extends Model
{
    ...
    /**
     * Get the view box price.
     *
     * @return string
     */
    public function getViewBoxPriceAttribute(): string
    {
        if($this->price_type !== 1) return "-";
        return currency_format($this->box_price);
    }


    /**
     * Get the view Unit price.
     *
     * @return string
     */
    public function getViewUnitPriceAttribute(): string
    {
        if($this->price_type !== 0) return "-";
        return currency_format($this->unit_price);
    }
